...
//	&& isset($_POST["pro_info"])
    ...
    array_push($insertArray, htmlspecialchars(strip_tags($pro_name)));
	array_push($insertArray, htmlspecialchars(strip_tags($pro_name_en)));
    array_push($insertArray, htmlspecialchars(strip_tags($pro_offer)));
	...
	array_push($insertArray, htmlspecialchars(strip_tags($pro_new_price)));
	array_push($insertArray, htmlspecialchars(strip_tags($pro_info)));
	array_push($insertArray, htmlspecialchars(strip_tags($pro_barcode)));
	array_push($insertArray, htmlspecialchars(strip_tags($pro_state)));
	array_push($insertArray, htmlspecialchars(strip_tags($pro_old_price)));
	array_push($insertArray, htmlspecialchars(strip_tags($pro_not)));
	array_push($insertArray, htmlspecialchars(strip_tags($pro_color)));
	array_push($insertArray, htmlspecialchars(strip_tags($pro_size)));
	...
	array_push($insertArray, htmlspecialchars(strip_tags($sec_id)));

	$sql = "insert into product
			(pro_name ,pro_name_en ,pro_offer  ,pro_image , pro_thumbnail,pro_new_price,pro_info,pro_barcode,pro_state,pro_old_price,pro_not,pro_color,pro_size,cit_id,str_id,sho_id,sec_id,pro_regdate)
			values(? , ? , ?,?,? ,?,?,?,?,?,?,?,?,?,?,?,?,now())";
