...
if (
    ...
    $sho_id = $_POST["sho_id"];
    $sli_de	s = $_POST["sli_des"];
    $sli_mess = $_POST["sli_mess"];
	
	$updateArray = array();
    array_push($updateArray, htmlspecialchars(strip_tags($sli_name)));
    array_push($updateArray, htmlspecialchars(strip_tags($sho_id)));
    array_push($updateArray, htmlspecialchars(strip_tags($sli_des)));
    array_push($updateArray, htmlspecialchars(strip_tags($sli_mess)));
    ...
    array_push($updateArray, htmlspecialchars(strip_tags($sli_id)));

	
		$sql = "update slider set sli_name=?,sho_id=?,sli_des=?,sli_mess=?,sli_image=?,sli_thumbnail=? 
		where sli_id=?";
