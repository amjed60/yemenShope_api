...
if (isset($_POST["foo_name"])
	...
	$foo_barcode=$_POST["foo_barcode"]== null ?"لايوجد باركود" : $_POST["foo_barcode"] ;
	...
	array_push($insertArray, htmlspecialchars(strip_tags($foo_barcode)));
